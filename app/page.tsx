      ...
      <main>
        ...
        <section className="sample-section">
          <div>
            ...
            <p>She loves Mum&apos;s favorite handbag, makeup brushes, and being just a little more grown-up every day.</p>
        ...
        <section className="how-section" id="how">
          ...
          <div className="steps">
            ...
            <article><span>2</span><h3>We make it</h3><p>Google AI Studio shapes a child-safe story, cohesive illustrations, and gentle narration.</p></article>
