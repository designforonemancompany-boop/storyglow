...
export default async function StoryPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  }))} cover={{ image_url: coverUrl, dedication: story.dedication }} initialPage={progress.data()?.page_number || 1} initialPosition={progress.data()?.audio_position_ms || 0} initialRate={Number(progress.data()?.playback_rate || 1)} />;
}
